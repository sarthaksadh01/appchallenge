...
<head>
    ...
    <!-- Website Title -->
    <title>App Innovation Challenge InfoXpression</title>
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#theme">THEMES</a>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="images/portrait.png" alt="alternative">
    ...
    <div id="features" class="tabs">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Event Details</h2>
                    <div class="p-heading p-large">A 24 hrs online app innovation challenge starts  from 10 October 2019 at 11 AM and ends on 11 October 2019 at 11 AM   !</div>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                ...
                <ul class="nav nav-tabs" id="lenoTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab"
                            aria-controls="tab-1" aria-selected="true"><i class="fas fa-cog"></i>Rules</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab"
                            aria-controls="tab-2" aria-selected="false"><i class="fas fa-binoculars"></i>Prizes</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="nav-tab-3" data-toggle="tab" href="#tab-3" role="tab"
                            aria-controls="tab-3" aria-selected="false"><i class="fas fa-search"></i>JUDGING
                            CRITERIA</a>
                    </li>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                ...
                                                <li>A maximum of 2 Developers can form a team.</li>
                                                <li>Teams should be made up exclusively of students. </li>
                                                <li>Team members could be of different institutions as well. Make sure
                                                    you have the proper Id-card
                                                    for reference.</li>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                ...
                                                <li>The Registration phase begins on 22nd of September 2019 And ends at
                                                    9 of
                                                    October 2019 23:59:59 hrs.</li>
                                                <li>Teams are required to register on the website <a
                                                        href="https://idroid.infoxpression.in/">idroid.infoxpression.in</a>
                                                </li>
                                                <li>Only one person in the team would be the team leader, who is
                                                    required to register on the website.</li>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card-deck">
                                        <div class="card">
                                            <i style="color:	#FFD700	;font-size:70px;"
                                                class="text-center fas fa-trophy"></i>
                                            <div class="card-body">
                                                <h5 class="text-center card-title">Winner</h5>
                                        ...
                                        <div class="card">
                                            <i style="color:	#c0c0c0	;font-size:70px;"
                                                class="text-center fab fa-dyalog"></i>
                                            <div class="card-body">
                                                <h5 class="text-center card-title">Best Design</h5>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="text-wrapper">
                                                        ...
                                                        <p> Did the team put thought into the user experience? How well designed is the interface? </p>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="text-wrapper">
                                                      ...
                                                      <p> Does the app work? Did the team achieve everything they wanted?</p>
    ...
    <div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3>Goals Setting</h3>
                <hr>
                <p>Leno can easily help you track your personal development evolution if you take the time to set it up.
                </p>
                <h4>User Feedback</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-map-marker-alt"></i>InfoXpression</li>
                        <li><i class="fas fa-phone"></i><a class="blue" href="tel:8650605941">8650605941</a></li>
                        <li><i class="fas fa-phone"></i><a class="blue" href="tel:8076911425">8076911425</a></li>
                        <li><i class="fas fa-envelope"></i><a class="blue"
                                href="mailto:infox@gmail.com">infox@gmail.com</a></li>
                    </ul>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group checkbox">
                            <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I agree with all T&C
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-col">
                        <h4>Contact Us</h4>
                       <p>Ankit 8650605941</p>
                       <p>Sarthak 8076911425</p>
                       <p>Divyansh 96435 69434</p>
                    </div>
                </div> <!-- end of col -->
                <div class="col-md-4">
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">InfoXpression 2019 <a class="turquoise"
                                        href="https://infoxpression.in">infoxpression.in</a></div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Techspace, USICT <a class="turquoise"
                                        href="https://techspace.club">techspace.club</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
                <div class="col-md-4">
                    <div class="footer-col last">
                        <h4>Social Media</h4>
                        <span class="fa-stack">
                            <a target = "_blank" href="https://www.facebook.com/infoxpression/">
                        ...
                        <span class="fa-stack">
                            <a  target = "_blank" href="https://www.instagram.com/infoxggsipu/">
                                <i class="fas fa-circle fa-stack-2x"></i>
                                <i class="fab fa-instagram fa-stack-1x"></i>
                            </a>
                        </span>
                        <span class="fa-stack">
                            <a target = "_blank" href="https://medium.com/techspace-usict/">
                                <i class="fas fa-circle fa-stack-2x"></i>
